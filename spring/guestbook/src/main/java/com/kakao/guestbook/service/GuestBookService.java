...
public interface GuestBookService {
    //데이터 삽입을 위한 메서드 - 기본키의 값을 리턴
    //매개변수는 대부분의 경우 DTO
    //리턴타입은 삽입된 데이터를 그대로 리턴하기도 하고
    //성공과 실패 여부를 위해서 boolean을 리턴하기도 함
    //영향받은 행의 개수를 의미하는 int를 리턴하기도 하며
    //기본키의 값을 리턴하는 경우도 있음
    ...
    default GuestBook dtoToEntity(GuestBookDTO dto){
        //삽입 날짜 와 수정 날짜는 entity가 삽입되거나 수정될 때 생성되므로 옮겨줄 필요가 없음
